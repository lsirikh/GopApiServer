...
> **현재 버전**: v6.3.1 (2026-07-31 버그픽스 — PROXY 기본 시드 누락 보강(필수 유형 보장) + proxy-settings PROXY 서버 전용 강제. `release/v6.3` 브랜치).
...
| 버전 | 날짜 | 헤드라인 |
|---|---|---|
| **v6.3.1** | 2026-07-31 | **버그픽스** — PROXY 기본 시드 누락 보강(필수 유형 보장) + proxy-settings PROXY 전용 강제 |
