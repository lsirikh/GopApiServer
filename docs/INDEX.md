...
- **마지막 갱신**: 2026-07-09 (advance-phase 자동)
- **총 문서 수**: 27개
...
| [PRD_GOP_Server_Reports_Generation_Lifecycle.md](prds/PRD_GOP_Server_Reports_Generation_Lifecycle.md) | PRD_GOP_Server_Reports_Generation_Lifecycle.md | Draft | 2026-07-04 |
| [PRD_GOP_Server_Reports_PDF_Persistence.md](prds/PRD_GOP_Server_Reports_PDF_Persistence.md) | PRD_GOP_Server_Reports_PDF_Persistence.md | Draft | 2026-07-04 |
...
| [BUG_REPORT_REPORT_GENERATIONS_LIST_SCHEMA_MISMATCH.md](reports/BUG_REPORT_REPORT_GENERATIONS_LIST_SCHEMA_MISMATCH.md) | [PRD](prds/BUG_REPORT_REPORT_GENERATIONS_LIST_SCHEMA_MISMATCH.md-prd.md) → [Plan](plans/BUG_REPORT_REPORT_GENERATIONS_LIST_SCHEMA_MISMATCH.md-prd-plan.md) | 2026-07-06 |
| [BUG_REPORT_REPORT_STATUS_SCHEMA_MISMATCH.md](reports/BUG_REPORT_REPORT_STATUS_SCHEMA_MISMATCH.md) | [PRD](prds/BUG_REPORT_REPORT_STATUS_SCHEMA_MISMATCH.md-prd.md) → [Plan](plans/BUG_REPORT_REPORT_STATUS_SCHEMA_MISMATCH.md-prd-plan.md) | 2026-07-06 |
| [BUG_REPORT_USER_ROLE_ENUM_MISMATCH.md](reports/BUG_REPORT_USER_ROLE_ENUM_MISMATCH.md) | [PRD](prds/BUG_REPORT_USER_ROLE_ENUM_MISMATCH.md-prd.md) → [Plan](plans/BUG_REPORT_USER_ROLE_ENUM_MISMATCH.md-prd-plan.md) | 2026-07-06 |
