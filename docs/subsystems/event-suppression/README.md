...
> 🔜 **예정 변경 통지**: 정비 창 **반복 스케줄**(월~금 08:00~21:00 · 기간 무제한 가능) 설계가 확정됐습니다.
> **[RECURRENCE.md](RECURRENCE.md)** 를 먼저 보세요 — `status=active` 의 의미가 바뀌고
> `window_end` 가 `null` 이 될 수 있어 **전 팀 대응이 필요**합니다.
