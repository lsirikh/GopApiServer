...
class TestEnumEventCategory:
    """EnumEventCategory 테스트 - 신규 Enum"""

    def test_enum_event_category_has_all_values(self):
        """EnumEventCategory가 8개 값을 모두 포함하는지 확인"""
        expected_values = [
            "NONE",
            "FENCE_SENSOR_ONLY",
        ...
        actual_values = [e.value for e in EnumEventCategory]
    ...
    def test_enum_event_category_legacy_mapping(self):
        ...
        for legacy_value, new_value in legacy_mappings.items():
            ...
            result = EnumEventCategory(legacy_value)
    ...
    def test_enum_event_category_sensor_with_camera_unchanged(self):
        ...
        assert EnumEventCategory.SENSOR_WITH_CAMERA.value == "SENSOR_WITH_CAMERA"
